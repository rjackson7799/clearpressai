/**
 * ClearPress AI - PR Portal Notifications Page
 * List of notifications for PR staff and admins
 */
...
export function NotificationsPage() {
  ...
  const handleNotificationClick = (notification: Notification) => {
    ...
    if (notification.metadata?.link) {
      ...
      navigate(`/pr/projects/${notification.metadata.project_id}/content/${notification.metadata.content_item_id}`);
    } else if (notification.metadata?.project_id) {
      navigate(`/pr/projects/${notification.metadata.project_id}`);
    }
  };
