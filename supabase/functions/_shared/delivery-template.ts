/**
 * Delivery body template helpers. Drift-guarded against
 * src/lib/delivery-template.ts via vitest in delivery-template.drift.test.ts.
 *
 * Composer uses these for live preview; the Edge Function uses them at send
 * time. Mirror parity is what makes "the preview is faithful" true.
 */
